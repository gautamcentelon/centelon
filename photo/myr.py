...
# Example usage
image_url = "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcRJJl1JVteu3yrH5lZoBCRWxvQd2JTqR8RJG8mBRouu7YDwu3qR1jzOtP9RkYqLTLPRUE8_srIa4CFPgXvyuBHCRA"  # Replace with your image URL
downloaded_image_path = download_image(image_url)

if downloaded_image_path:
    try:
        print_photo(downloaded_image_path)
    finally:
        # Clean up the temporary file
        os.remove(downloaded_image_path)
        print(f"Deleted temporary file: {downloaded_image_path}")
